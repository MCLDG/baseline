...
11. If you cannot access the endpoint, try to access the graphql endpoint by entering this in the browser. This will only work if the endpoint is available, which you will have confirmed by running `npm run test` above:
